...
const OUTPUT_FILES = {
  ...
  ratingSummary: "吏덈Ц3_愿?뚮벑湲??붿빟.csv",
  theaterBandSummary: "吏덈Ц4_洹뱀옣??援ш컙_?붿빟.csv",
  theaterCorrelationSummary: "吏덈Ц4_洹뱀옣???곴?_?붿빟.json",
  covidPeriodSummary: "吏덈Ц5_肄붾줈?섏떆湲??붿빟.csv",
  markdownSummary: "遺꾩꽍_吏덈Ц_?붿빟.md",
};
